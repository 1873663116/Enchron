...
struct WebDAVDataSourceAdapterTests {
    ...
    private static let directoryListing = """
...
private final class WebDAVRequestRecorder: @unchecked Sendable {
...
private final class RecordingWebDAVCredentialStore: CredentialStoring, @unchecked Sendable {
    private let lock = NSLock()
...
private final class WebDAVURLProtocolHandlerStore: @unchecked Sendable {
    private let lock = NSLock()
