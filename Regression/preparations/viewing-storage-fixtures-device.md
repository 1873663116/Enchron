---
{
  ...
  "schemaVersion": 1,
  "id": "preparation:viewing-storage-fixtures-device",
  "title": "Prepare viewing storage fixtures device",
  "lane": "device",
  ...
  "operations": [
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:01",
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:02",
      "operation": "operation:harness.ensure-session@1",
      "arguments": {},
      "maxInvocations": 1
    },
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:03",
      "operation": "operation:app.relaunch@1",
      "arguments": {},
      "maxInvocations": 1
    },
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:04",
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:05",
      "operation": "operation:harness.assert-channels@2",
      "arguments": {},
      "maxInvocations": 1
    },
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:06",
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:07",
      "operation": "operation:media.stage-fixture@2",
      "arguments": {
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:08",
      "operation": "operation:media.stage-fixture@2",
      "arguments": {
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:09",
      "operation": "operation:media.stage-fixture@2",
      "arguments": {
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:10",
      "operation": "operation:media.stage-fixture@2",
      "arguments": {
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:11",
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:12",
      "operation": "operation:storage.clear@1",
      "arguments": {
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:13",
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:14",
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:15",
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:16",
      "operation": "operation:accessibility.type@2",
      "arguments": {
        "context": "main-window-browser",
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:17",
      "operation": "operation:accessibility.type@2",
      "arguments": {
        "context": "main-window-browser",
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:18",
      "operation": "operation:accessibility.type@2",
      "arguments": {
        "context": "main-window-browser",
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:19",
      "operation": "operation:accessibility.activate@2",
      "arguments": {
        "context": "main-window-browser",
        "identifiers": [
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:20",
      "operation": "operation:accessibility.activate@2",
      "arguments": {
        "context": "main-window-browser",
        "identifiers": [
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:21",
      "operation": "operation:accessibility.activate@2",
      "arguments": {
        "context": "main-window-browser",
        "labels": [
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:22",
    ...
    {
      "callId": "call:preparation:viewing-storage-fixtures-device:23",
      "operation": "operation:host.preflight@1",
      "arguments": {
        "check": "webdav-regression"
      },
  ...
  "produces": [
    {
      ...
      "producedByCall": "call:preparation:viewing-storage-fixtures-device:23",
      "dependsOnTags": [
        "app.session",
        "cache.state",
        "certificate.trust",
...
---
# Prepare viewing storage fixtures device
