---
{
  ...
  "criteria": [
    ...
    "The final activePlayback has a non-none sessionID different from the pre-exit sessionID, viewingStateAuthority enchron-persistence, the same mediaIdentity and contentRevision as the persisted entry, and positionSeconds greater than zero and within 5 seconds of the persisted entry positionSeconds.",
