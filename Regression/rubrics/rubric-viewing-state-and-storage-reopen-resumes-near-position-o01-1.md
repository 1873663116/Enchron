---
{
  ...
  "negativeControls": [
    "A visible panel without a successful primary action, or a primary action without the inlined matched panel and final structured snapshot, is inadmissible.",
    ...
    "priorSnapshotDigests hashes without the inlined persisted viewingStorageObservation and resume-panel matchedElement cannot establish the five-second bound or panel presence."
  ]
}
---
