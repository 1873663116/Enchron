---
{
  ...
  "criteria": [
    ...
    "relatedResults inline the PlayerUI-resumeDecision-panel matchedElement from call 13, which is null, and the ordered transcript contains no activation of either resume-decision action. Playback reaches playing automatically.",
  ...
  "negativeControls": [
    "A near-end seek or Back without an inlined natural Ended snapshot and endedNaturally true cannot establish completion; a missing structured end, persistence, or resume-panel observation is Indeterminate.",
