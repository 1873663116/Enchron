---
{
  ...
  "criteria": [
    "For the bound caseKey, the independent attempt opens its real media identity and invokes playback.select-subtitle with host playerUI, the matching sourceKind, and deadlineSeconds within 1 through 90. Local and WebDAV sidecars use the registered sdr-bframe-aggregate-30s.zh-CN.srt label; the Emby case starts playback from the series-page episode card labeled Enchron Regression Episode and discovers the sole external track from the verified seed receipt.",
