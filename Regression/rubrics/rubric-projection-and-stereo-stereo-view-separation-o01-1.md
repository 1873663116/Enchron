---
{
  ...
  "criteria": [
    "In the current media segment, side-by-side opens MediaLibrary-grid-video-180_3D.mp4 and its bound format.apply operationOutput.captureRequest is {context: portal, count: 3, minimumIntervalMillis: 1000}; top-bottom opens MediaLibrary-grid-video-180_3D_TB.mp4 with the same embedded capture request; mv-hevc-two-view opens MediaLibrary-grid-video-spatial_lighthouse_flowers_waves_short.mov and its bound capture producer requests {context: window, count: 3, minimumIntervalMillis: 500}.",
