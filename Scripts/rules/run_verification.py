...
STRUCTURE_CHECKS = (
    ...
    StructureCheck("browser-window-visibility", "verify_browser_window_visibility.py"),
    ...
    StructureCheck("unittest-main-guard", "verify_unittest_main_guard.py"),
    StructureCheck(
        "bootstrap-freeze",
    ...
    StructureCheck("episode-switch-captures-frames", "check_episode_switch_captures_frames.py"),
