...
class OneVerbOneActionTests(unittest.TestCase):
    ...
    def test_real_repository_has_no_violations_except_exempted(self) -> None:
        ...
        with patch.object(checker, "REPOSITORY_ROOT", original_root), patch.object(checker, "CHANNEL_PATH", original_root / "Apps/Enchron/DebugSupport/TestCommandChannel.swift"):
            self.assertEqual(checker.failures(), [])
