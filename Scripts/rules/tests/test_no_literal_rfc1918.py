...
class CoreDeviceIdentifierTests(unittest.TestCase):
    ...
    def test_a_uuid_typed_out_of_a_handful_of_digits_is_a_fixture_value(self) -> None:
        ...
        `Scripts/rules/tests/test_regression_system_import.py` passes a UUID
        built out of three distinct digits to `device_identifier=` to prove a
        ...
        """
        self.write(
            "Scripts/rules/tests/test_regression_system_import.py",
