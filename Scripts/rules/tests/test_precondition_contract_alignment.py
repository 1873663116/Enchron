...
class PreconditionContractAlignmentTests(unittest.TestCase):
    ...
    def test_real_repository_has_no_violations(self) -> None:
        ...
        with patch.object(checker, "REPOSITORY_ROOT", original_root), patch.object(checker, "CHANNEL_PATH", original_root / "Apps/Enchron/DebugSupport/TestCommandChannel.swift"), patch.object(checker, "OPERATIONS_ROOT", original_root / "Regression/operations"):
            self.assertEqual(checker.failures(), [])
