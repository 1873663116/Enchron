...
PATHS: dict[str, tuple[Step, ...]] = {
    ...
    "dock-roundtrip": (Step("open", OPEN_CLIP, PANORAMIC_WINDOW), Step("apply-flat-mono", APPLY_FLAT_MONO, "window"), Step("enter-docked", ("PlayerUI-TopAction-dock","PlayerUI-DockMenu-default"), FLAT_IMMERSIVE), Step("exit-to-window", ("PlayerPanel-button-exit-spatial",), FLAT_WINDOW)),
    ...
    "clean-dock-cycle": (Step("open", OPEN_CLIP, "window"), Step("enter-docked-1", ("summon:PlayerUI-TopAction-dock","PlayerUI-DockMenu-default"), "docked"), Step("exit-to-window-1", ("summon:PlayerPanel-button-exit-spatial",), FLAT_WINDOW), Step("enter-docked-2", ("summon:PlayerUI-TopAction-dock","PlayerUI-DockMenu-default"), "docked"), Step("exit-to-window-2", ("summon:PlayerPanel-button-exit-spatial",), FLAT_WINDOW)),
