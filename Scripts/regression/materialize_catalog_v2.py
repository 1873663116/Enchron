...
def _validate_blueprint(
    ...
    _require(actual["promises"] == 65 and actual["scenarios"] == 70, "Catalog must contain 65 Promises and 70 Scenarios")
    ...
    _require(len(scenario_ids) == 70, "Scenario IDs must be unique")
