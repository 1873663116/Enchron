...
def main() -> None:
    ...
    rewrite_case_rubric(
        ...
        [
            "For caseKey profile-8-hdr10, the bound artifact follows one surface to videoFormat to apply transaction, preserves source tuple (8,1,false) and source format atoms, and shows the reviewed HDR10/PQ renderer branch.",
            "For caseKey profile-8-hlg, the bound artifact follows one surface to videoFormat to apply transaction, preserves source tuple (8,4,false) and source format atoms, and shows the reviewed HLG/B67 renderer branch.",
