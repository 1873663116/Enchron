...
- Window chrome 左上角拥有退出当前媒体，右上角依次放置 Dock、Video Format 与 More。视频画面不叠加媒体标题和格式信息。Dock 使用系统原生 `Menu` 选择 Environment 与 Day/Night Effect；Video Format 使用内联自绘二级面板。
