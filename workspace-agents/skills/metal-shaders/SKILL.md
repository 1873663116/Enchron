---
name: metal-shaders
description: Build and debug production Metal shaders for Apple platforms, including SwiftUI stitchable effects (colorEffect, distortionEffect, layerEffect), MPS usage, compute shaders, ray marching, SDF, volumetric rendering, noise functions, and real-time GPU performance practices.
---
