...
- `Session/` 活动会话对象与诊断探针（`PlaybackSessionModel`、`SurfaceInputProbes`、`DebugProbeJournal`）；
...
**它是否属于本地与网络文件浏览**——库模型、来源浏览、目录扫描、SMB/WebDAV/本地适配器、字幕关联？属 [`Modules/MediaLibrary`](Modules/MediaLibrary)。
